...
# Set Streamlit Page Configuration - optimized for responsive phone screens
st.set_page_config(
...
if page == "📊 Dashboard":
    ...
    if not df.empty:
        ...
        # Native Streamlit metrics visualization without heavy libraries
        st.subheader("Bookings Per Event Type")
        event_counts = df_active["Event Type"].value_counts()
